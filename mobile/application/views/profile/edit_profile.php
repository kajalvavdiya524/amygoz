...
<div class="profile-block">
    <div class="profile-detail" style="padding:30px 10px;">
                                ...
                                <div class="modal-body">
                                   ...
                                   <?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="mobile-number" maxlength="13" type="text" name="phone" placeholder="What's your phone number?" value="<?php echo $user->user_detail->phone; ?>">
                                    </div>
