...
<div class="row pad-bck-1">
    <div class="col-sm-12">
        <div class="">
        <div class="box">
            <div class="top" style="border-bottom: 1px solid #d5d5d5;color: #00bcd4;">
            <div class="">
                <h4><span class="glyphicon glyphicon-heart pull-left"></span>&nbsp;&nbsp;&nbsp;&nbsp;Requests Received<i class="fa fa-chevron-down pull-right"></i></h4>
            </div>
            </div>
            <div class="bottom" style="padding: 8px 0px;border-bottom: 1px solid #c8c8c8;">
            <?php if (!empty($arequests)) { ?>
                <div class="container">
                    <?php foreach ($arequests as $arequest) { ?>
                        ...
                        <div class="row">
                        <div class="col-xs-2">
                            <span class="glyphicon glyphicon-user pull-left cillijong"> 
                            </span>
                            </div>
                            <div class="col-xs-10" style="border-bottom: 1px solid #ededed;">
                            <p style="font-size: 16px;font-weight: 500;position: relative;right: 17px;top:4px;">You have a <?php echo $arequest->plan; ?> request</p>
                           </div>
                           </div>
                        </a>
                    <?php } ?>
            ...
            <?php } else { ?>
                <div class="request-review-panel text-center">
                    <i class="fa fa-frown-o fa-5x"></i>
                     <h5 style="text-align: center;">You don't have any incoming requests</h5>
...
<div class="row bg-pad-1">
    <div class="col-sm-12">
        <div class="">
            <div class="panel-heading">
            <h4 style="font-weight: 500;text-align: center;">Don't be shy!</h4>
                <h5 style="font-weight: 500;font-size: 16px;text-align: center;">Send a Request for coffee or lunch </h5>
            </div>
            <div class="">
                <div class="row">
                        ...
                        <div class="fieldset-inner">
                            <form class="validate-form userAutoCompleteForm" method="post" action="<?php echo url::base() . "activity/send"; ?>" role="form">
                                ...
                                <div class="form-group" style="position:relative;">
                                    <label class="control-label" for="message-email">With Whom?
                                        <!-- <small class="muted dis-block">Please enter the email address</small> -->
                                    </label>
...
<?php } ?>
                                ...
                                <button type="submit" class="btn btn-span-ty" style="background: none;color: #12a6bb;border: 2px solid #12a6bb;font-weight: 600;"><span class="glyphicon glyphicon-send"></span> Send Anonymously</button>
