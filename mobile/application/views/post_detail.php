            ...
            <div class="marTop20">
                <div class="post" style="box-shadow:0 0 0 1px rgba(0,0,0,.1),0 2px 3px rgba(0,0,0,.2);background:#fefefe; border-radius: 3px 3px 0px 0px;padding: 20px;">
                    <div class="row">
                                    ...
                                    <div class="fileinput-preview" id="imagerather" style="overflow: hidden; background-color: white;">
                                        <a href="<?php echo url::base().$post->user->username; ?>">
                                            ...
                                            if(!empty($photo) && $post_image) { ?>
                                                <img class="img-responsive post-img" src="<?php echo url::base().'mobile/upload/'.$post->user->photo->profile_pic;?>" alt="<?php echo $post->user->user_detail->first_name." ".$post->user->user_detail->last_name;?>" height="100%">
                                            <?php }
                                            else if(!empty($photo) && $post_image1) { ?>
                                                <img class="img-responsive post-img" src="<?php echo url::base().'upload/'.$post->user->photo->profile_pic;?>" alt="<?php echo $post->user->user_detail->first_name." ".$post->user->user_detail->last_name;?>" height="100%">
                                            <?php } else { ?>
                        ...
                        <div class="col-sm-12" style="margin-top: 5px;padding-left: 8px;white-space: normal;">
                            <div id="postWrap">
