...
<?php } else { ?>
    <?php foreach($users as $user) { ?>
        <?php if ($i < 5) { ?>
            <div class="post friends_for_noti" style="width:auto;">
                <a href="<?php echo url::base().$user->username; ?>">
                    <div class="user-img hb-mr-5 pull-left picbox">
                        <?php if($user->photo->profile_pic_s) { ?>
                            <img src="<?php echo url::base()."upload/".$user->photo->profile_pic_s;?>" style="width:50px; height:50px">
                        <?php } else { ?>
                    ...
                    <div class="post-content">
                        <div class="post-title" style="color: #cf2257;">
                            <strong>
        ...
        <?php } else { ?>
            <div class="post friends_for_noti text-center">
                <form action="<?php echo url::base() . 'members/search'; ?>" method="post">
                    ...
                    <input type="submit" style="background: none;border: 0px;font-size: 17px;color: #235E68;" value="See more result for '<?php print_r($search_word); ?>'"  name="submit">
                </form>
            </div>
        <?php break; } ?>
    <?php $i++; } ?>
