                        ...
                        <?php if (isset($session_user->id) && $session_user->is_active == 0) { ?>
                            <div class="alert alert-warning" style="margin-bottom:0px;">
                                <span class="not-active-warning">
                                    <?php echo $session_user->user_detail->first_name; ?>
                            ...
                            ?>
                                    <div class="alert alert-info text-center">
                                        ...
                                        <h4 class="dis-inline marRight20">
                                            ...
                                            thinks 
                                            <a href="<?php echo url::base() . $match_exists->match_to->username; ?>">
                                                <?php echo $match_exists->match_to->user_detail->first_name; ?>
                                            </a>
                                            is a good match for you. What do you think? 
                                        </h4>
                                        <button class="accept-match btn btn-secondary marRight20">
                                            <small class="dis-block">
                                                I'm interested in <?php echo $match_exists->match_to->user_detail->first_name; ?>
                                            </small>
                                            Accept Match
                                        </button>
                                ...
                                ?>
                                        <div class="alert alert-info text-center">
                                            ...
                                            <h4 class="in-block marRight20">
                                                ...
                                                thinks 
                                                <a href="<?php echo url::base() . $match_conf->match_with->username; ?>">
                                                    <?php echo $match_conf->match_with->user_detail->first_name; ?>
                                                </a>
                                            ...
                                            <button class="accept-match btn btn-secondary marRight20">
                                                <small class="dis-block">
                                                    I'm interstested in <?php echo $match_conf->match_with->user_detail->first_name; ?>
                                                </small>
                                                Accept Match
                                            </button>
                                            <button class="reject-match btn btn-primary">
                                                <small class="dis-block">
                                                    Not interested in <?php echo $match_conf->match_with->user_detail->first_name; ?>
                                                </small>
                                                Reject Match
                                            </button>
                                        </div>    
