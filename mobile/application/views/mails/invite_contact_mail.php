...
@media only screen and (max-width: 768px) {
    ...
    <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
       ...
       <td style="width: 49px;vertical-align: middle;">                                                         
        ...
        Hi <?php echo ucwords($user->user_detail->first_name.' '.$user->user_detail->last_name);?>,
                </span>
              </p>
            </td>
          </tr>
        ...
        I want to personally invite you to join my network. 
            </p>
            </td>
          </tr>
        </table>
  ...
  <table class="sprty">
    <tr>
      <td class="row">
        ...
        <a href="<?php echo url::base()."pages/redirect_to/".$user_to->username ."?page=".urlencode($from->username); ?>" style="text-decoration:none; color:#00bcd4;">
        <?php 
       ...
       <?php echo $from->user_detail->first_name[0]."".$from->user_detail->last_name[0];?> 
        ...
        <li class="unline-list" style="list-style-type: none;">
            <p class="text-sharp posh-ytr" style="font-weight:500;font-size: 13px;">
              ...
              <?php echo $from->user_detail->first_name." ".$user->user_detail->last_name;?>  
              </span>
              <br/>  
        ...
        <table class="sprty">
           <tr>
              <td>
              <span style="color:#888; font-size:15px; padding: 25px 25px 0px 30px;">
                   Please join now and write few good words for me.
                   </span>
            </td>
          </tr>
      </table>
<br/><br/>
    <table class="sprty" style="text-align: center;">
        <tr>
          <td>
            <p style="color:#888; font-size:15px;text-align: center;padding: 25px 0px 30px 30px;">
       ...
       <table class="sprty">
            <tr>
                ...
                <span style="color: black"> 
                      Regards,<br /><br />
                      <?php echo $user->user_detail->first_name." ".$user->user_detail->last_name;?>  <br />                     
                     </span>
                     <br/>                                                   
        <p style="text-align: center;">                                                                                     
        <small style="text-align: center;">You are receiving this message because a member wanted to connect with you. You can manage your email subscription preferences <a href="<?php echo url::base();?>/account/email_notification_settings">here</a>
        </small>
          </p>
                </td>
              </tr>
