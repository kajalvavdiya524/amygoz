    ...
    <body>
      ...
      <tr>
        ...
        <table class="sprty">
            <tr>
              <td>                                               
          <p style="color:#888; font-size:15px;padding: 10px 25px 4px 30px;">
        <?php echo ucwords($match->match_by->user_detail->first_name.' '.$match->match_by->user_detail->last_name);?>
         ...
         <tr>
              <td>                                               
          <p style="color:#888; font-size:15px;padding: 0px 25px 2px 30px;">      
        <?php echo $match->match_by->user_detail->first_name." ".$match->match_by->user_detail->last_name; ?> thinks <?php echo $match->match_to->user_detail->first_name; ?> is a good match for you. What do you think?
          </p>
          </td>
          </tr> 
          ...
          <tr>
            <td>                                               
          <p style="color:#888; font-size:15px;padding: 4px 25px 35px 30px;">                                                
