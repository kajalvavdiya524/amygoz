    ...
    <body>
      ...
      <tr>
       ...
       <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
        ...
        <?php echo ucwords($newemail1->first_name[0])."".ucwords($newemail1->last_name[0]);?>
        </span>
        <?php } ?>
            </td>
          </tr>
       ...
       <table class="sprty">
        ...
        Hi <?php echo $newemail1->first_name;?>,
              </p>
            </td>
          </tr>
          <tr>
            <td>                                               
          <p style="color:#888; font-size:15px;padding: 20px 25px 10px 30px;">
        <?php echo ucwords($from->user_detail->first_name." ".$from->user_detail->last_name);?> wants to see your profile picture.
                </p>
            </td>
          </tr>
        </table>   
...
<table class="sprty">
    ...
    <table class="sprty">
        ...
        Your profile is missing photo. Please upload your picture.
        </p>
       </td>
     </tr>  
       ...
       <tr style="text-align: center;margin-top: 25px;">
        ...
        <a target="_blank" style="text-decoration:none; color:#fff;background: #00bcd4;padding: 9px 35px;text-align: center; " href="<?php echo url::base()."pages/redirect_to/".$newemail->username."?page=".urlencode($newemail->username."/edit_profile"); ?>">Upload Here
            </a>
          </p>
       </td>
     </tr>
