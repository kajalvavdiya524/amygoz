                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                               ...
                                               <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="color:#888; padding:0 0 18px;">
                                                        <p style="margin:0;word-wrap:break-word;color:none;word-break:break-word;font-weight:400;font-size:15px;line-height:1.429;">You have not uploaded profile photo. Profiles with a photo are likely to get more response than the ones without pictures.</p> 
                                                        <br/> <br/>   
