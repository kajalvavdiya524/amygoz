...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty brd-pag-2">
      ...
      <img alt="" src="<?php echo url::base().'mobile/upload/'.$user_to->photo->profile_pic;?>" style="width: 35px;height: 35px;border-radius: 50%;padding: 0px 2px 0px 0px;">
      <?php }  
      ...
      Hi <?php echo $user_to->user_detail->first_name;?>,
  ...
  <table class="sprty">
    ...
    <img alt="" src="<?php echo url::base().'upload/'.$from->photo->profile_pic;?>" class="img-rect posh-ytr" style="width: 50px;height: 50px;border-radius: 50%;float: left;">
      ...
      <table class="sprty">
        <tr>
          <td>                                               
          <p style="color:black; font-size:16px;font-weight: 500;padding:20px 25px 10px 30px;">                                   
       <?php echo substr($message, 0, 25)."....."; ?>
         ...
         <table class="sprty">
          ...
          <p style="color:#888; font-size:14px;padding: 20px 0px 10px 0px;">                                  
        Please <a href="<?php echo url::base() . "pages/redirect_to/" . $user_to->username . "?page=" . urlencode("messages"); ?>" style="color: #01BF01;text-decoration:none;"> login to your account</a> to view full message.
          </p>
        </td>
      </tr>
    </table>
       ...
       <table class="sprty">
        <tr class="row">
          <td class="col-xs-12" style="text-align: center;padding:20px 0px 35px 0px;">                                             
