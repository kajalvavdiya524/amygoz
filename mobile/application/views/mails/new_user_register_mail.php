...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty brd-pag-2">
      ...
      <table class="sprty">
        <tr>
         ...
         <?php echo ucwords($from->user_detail->first_name)." ".ucwords($from->user_detail->last_name);?> has invited you to go for <?php echo $plan; ?> <?php echo $message; ?> !
                </p>
             </td>
           </tr> 
        </table> 
    ...
    <table class="sprty" style="text-align: center;">
        ...
        <tr style="text-align: center;">
            <td>                                                
        Join Callitme and invite your friend for a ride or your crush for a date.<br/> 
        <a style="background:#00bcd4;padding: 9px 35px;color: #fff;text-decoration: none;" href="<?php echo url::base() . "pages/redirect_to/" ."?page=" . urlencode('register'); ?>" target="_blank" class="btn btn-danger">
