                                    ...
                                    <tr>
                                        <td data-bgcolor="bg-block" class="holder" style="padding:8px 60px 52px;" bgcolor="#f9f9f9">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                               ...
                                               <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/5px Arial, Helvetica, sans-serif; color:#888; padding:0 0 18px;">
                                                        <p style="margin:0;word-wrap:break-word;color:none;word-break:break-word;font-weight:400;font-size:14px;line-height:1.429;font:13px/25px Arial;">This is a reminder to let you know that your Callitme account is still not activated. To enjoy the full features 
                                                        of Callitme, you must activate your account.</p>    
                                                    </td>      
                                                </tr>
                                                <tr>
                                                        ...
                                                        <table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
                                                                    <a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="<?php echo $link; ?>">Activation link</a>
                                                                </td>
                                                            </tr>                                                            
                                                        </table>
                                                    </td>
