...
@media only screen and (max-width: 768px) {
      ...
      <table class="sprty">
       ...
       Indeed, <?php echo $to->user_detail->first_name; ?></a> also wanted the same.<br/> Why wait? 
          ...
          <p style="color:#888; font-size:15px;padding: 0px 25px 0px 30px;">
        <a href="<?php echo url::base()."pages/redirect_to/".$owner->username ."?page=".urlencode($to->username); ?>" style="color: #01BF01;text-decoration:none;">
        log in</a> to your Callitme account and get in touch with <a href="<?php echo url::base()."pages/redirect_to/".$owner->username ."?page=".urlencode($to->username); ?>" style="color: #01BF01;text-decoration:none;">
...
<img src="<?php echo url::base();?>/img/icon/blogger.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;margin: 0px 6px 0px 0px;padding: 0px 2px;" align="left" vspace="0" hspace="0" width="20" height="20" alt="bloog" /></a>
     ...
     <img src="<?php echo url::base();?>/img/icon/google-plus.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;margin: 0px 6px 0px 0px;padding: 0px 2px;" align="left" vspace="0" hspace="0" width="20" height="20" alt="google plus" /></a>
      ...
      <P style="text-align: center;">                                                     
       <small style="text-align: center;">You are receiving this message because you are a member of Callitme. You can manage your email subscription preferences <a href="<?php echo url::base();?>/account/email_notification_settings">here</a></small>
                </P>
               </td>
              </tr>
            </table> 
