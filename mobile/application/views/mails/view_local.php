    ...
    <table class="sprty brd-pag-2">
      <tr>
       ...
       <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
        ...
        Aren’t you curious to know who lives around you? With Callitme, you can see the members around you.  If you find them interesting, send them a request to meet for lunch!
        </span>
        </p>
        </td>
        </tr>
        ...
        <tr style="text-align:center;">
          <td>                                               
          <p style="color:#888; font-size:17px;padding: 5px 25px 35px 30px;">
        <a target="_blank" style="text-decoration:none; color:#fff;background:#00bcd4;padding:9px 40px;" href="<?php echo url::base()."pages/redirect_to/".$user->username ."?page=".urlencode("localpeople"); ?>">
        View local people
        </a>
        </p>
        </td>
