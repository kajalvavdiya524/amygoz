...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty brd-pag-2">
      ...
      <table class="sprty">
        ...
        <span style="color:#888; font-size:15px;padding: 2px 25px 35px 30px;">                                            
        <?php echo $friend->user_detail->get_name(); ?> is single.
        <a href="<?php echo url::base()."pages/redirect_to/".$user->username ."?page=".urlencode($friend->username); ?>" style="font-size:15px;color:#888;text-decoration: none;"> Connect <?php echo $friend->user_detail->get_name(); ?> with one of your friends
            </a>
          </span>
        </p>
      </td>
