     ...
     <table class="sprty brd-pag-2">
      <tr>
        ...
        <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
          <p class="park-tf">                                                   
        <?php echo ucwords($user_to->first_name.' '.$user_to->last_name);?>
        </p>
        </td>
        <td style="/*! text-align: right; */width: 49px;vertical-align: middle;">                                                                                                      
        <?php 
        $photo = $user_to->user->photo->profile_pic;
        $photo_image1 = file_exists("upload/".$photo);
        if(!empty($photo)&& $photo_image1) { ?>
        <img alt="" src="<?php echo url::base().'upload/'.$user_to->user->photo->profile_pic;?>" style="width: 35px;height: 35px;border-radius: 50%;padding: 0px 2px 0px 0px;">
        <?php }  else { ?>
        <span style="background-color:#bdbcbc;border-radius:50%;padding:8px;font-size:20px;margin:0px auto;text-align:center;">
        <?php echo ucwords($user_to->first_name[0])."".ucwords($user_to->last_name[0]);?>
          </span>                                                                      
        <?php } ?>
          </td>
          </tr>
       ...
       <table class="sprty">
            <tr>
                <td>                                                     
        <p style="color:#888; font-size:17px;padding: 10px 25px 0px 30px;">Hi <?php echo $user_to->first_name;?>,
        <br/><br/>
        <span style="color:#888; font-size:14px;padding: 0px 0px 0px 0px;">
  ...
  <table class="sprty">
    <tr>
      <td class="row">
        ...
        <?php } else { ?>
        <span style="background-color:#bdbcbc;border-radius:50%;padding:16px;font-size:20px;margin:0px auto;text-align:center;float: left;">
        ...
        <a style="color: #88889d;text-decoration: none;" href="<?php echo url::base() . "pages/redirect_to/" ."?page=" . urlencode($from->username); ?>"><?php echo $from->user_detail->first_name." ".$from->user_detail->last_name; ?>    
        </a> 
        </span>
        <br/>                                                                
        ...
        Social % <?php echo $from->calculate_social_percentage($tags);?>
         ...
         <table class="sprty">
            <tr>
                <td>                                               
          <p style="color:#888; font-size:15px;font-weight: 600;padding: 0px 25px 10px 30px;">                                                               
        <?php echo substr($message, 0, 25)."....."; ?>  
         ...
         <table class="sprty">
          ...
          <p style="color:#888; font-size:14px;padding: 10px 25px 10px 30px;">                                                            
        Please <a href="<?php echo url::base() . "pages/redirect_to/" . $user_to->user->username . "?page=" . urlencode("messages"); ?>" style="color: #01BF01;text-decoration:none;"> login to your Callitme 
                        </a> account to view full message.
                    </p>
                </td>
            </tr>
         </table>
        ...
        <a target="_blank" href="<?php echo url::base() . "pages/redirect_to/" . $user_to->user->username . "?page=" . urlencode("messages"); ?>" style="background:#00bcd4;padding: 9px 35px;color: #fff;text-decoration: none;">
        View Message
        </a>
         </td>
          </tr>
            ...
            <tr>
                ...
                <span style="color: black"> 
                     ...
                     <br/>                                                   
        <a target="_blank" style="text-decoration:none;" href="https://www.callitme.com/blog/"><img src="<?php echo url::base();?>/img/icon/blogger.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;padding: 0px 2px;" align="left" vspace="0" hspace="0" width="20" height="20" alt="bloog" /></a>
                                                           
        <a target="_blank" style="text-decoration:none;" href="https://www.facebook.com/callitme"><img src="<?php echo url::base();?>/img/icon/facebook.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;padding: 0px 2px;" align="left" vspace="0" hspace="0" width="20" height="20" alt="facebook" /></a>
                                                          
                                                               
        <a target="_blank" style="text-decoration:none;" href="https://plus.google.com/+Callitme"><img src="<?php echo url::base();?>/img/icon/google-plus.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;padding: 0px 2px;" align="left" vspace="0" hspace="0" width="20" height="20" alt="google plus" /></a>
                                                            
        <a target="_blank" style="text-decoration:none;" href="https://twitter.com/call_it_me"><img src="<?php echo url::base();?>/img/icon/twitter.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;padding: 0px 2px;" align="left" vspace="0" hspace="0" width="20" height="20" alt="twitter" /></a>
             <br/><br/> 
