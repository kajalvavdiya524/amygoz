            ...
            <div class="col-sm-12">
                <div class="alert alert-success alert-labeled hb-mt-15">
                    ...
                    <div class="alert-labeled-row">
                        ...
                        </span> You've signed out. see you again soon!
                        </p>
                    </div>
                </div>
            </div>
...
<section class="gap gap-fixed-height-large secondary-bg">        
    <div id="intro" class="skrollable skrollable-between">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3>It’s a great day to invite someone for lunch.</h3>
                </div>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <a href="<?php echo url::base()."login?page=activity";?>" class="btn btn-primary btn-block btn-lg hb-mt-40">Invite</a>
                    </div>
                </div>
            </div>
