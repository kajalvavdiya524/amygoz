<section class="">        
    <div class="" id="">
        <div class="container">
            <div class="row" style="background: #ff2a7f;">
                <div class="col-sm-8">
                    <h4 class="text-center" style="color: #fff;margin-top: 30px;">AREN’T YOU CURIOUS TO KNOW WHO LIVES AROUND YOU?</h4>
                </div>
                <div class="col-sm-4">
                    <img src="<?php echo url::base(); ?>img/home-window.jpg" class="img-responsive">
                </div>
            </div>
        </div> <!-- end container -->
    </div> <!-- end intro -->                
...
<!--<section id="review" class="primary-bg">
    <div class="container">
        <div class="row">
            <div class="col-sm-8">
                <h3>Match Singles</h3>
...
<!--
        ...
        <div class="home-register-box pull-right" style="background: rgba(255, 255, 255, 0.29);">
            <div class="">
                <div class="panel-heading text-center">
                    <h3 class="text-center" style="color: #ff2a7f;">
                        Login Now
                     </h3>
                </div>
                <form role="form" class="validate-form register-form" method="post" action="<?php echo url::base()."login"; ?>">
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="row" style="padding:10px">
                                <div class="col-sm-6">
                                <input type="hidden" name="page" value="localpeople">
                                    <!--<label class="control-label" for="email">Email address</label>-->
                                    <input type="email" class="required email  form-control"  name="email" id="email" placeholder="Enter email" style="margin-bottom: 8px;">
                                </div>
                                <div class="col-sm-6">
                        ...
                        <div class="col-sm-3 text-center">
                                    <button type="submit" class="btn" style="background: none;color: #ff2a7f;border: 1px solid #ff2a7f;width: 100%;">Log In</button>
                                </div> 
                            </div>
                             <p class="terms marTop10 pull-right">
                            New here?
                            <a href="<?php echo url::base()."register"; ?>" class="cyan"><strong>Register Yourself!.</strong></a>
                        </p>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5 answer-varification">
                                    ...
                                    <?php 
                                        ...
                                        $total = ($first+$second);*/
                                    ?>
                                    <input type="hidden" value="<?// echo $total;?>" name="total" id="total">
...
<div id="home-bottom" class="gap gap-fixed-height-large">
    <div class="container">
