...
class Controller_Profile extends Controller_Template {
    ...
    public function before() 
    {
        ...
        if(!$this->request->is_ajax()) {
            ...
            $this->template->title = 'Crowdprofiling, crowdmatching, social dating and people review';
    ...
    public function action_edit_profile() {
        ...
        $this->template->title = 'Edit Profile | Amygoz'; //Ash added
    }
  ...
  /*  public function action_profile_pic() {
    ...
    public function action_profile_pic() 
    {
        ...
        if( $this->request->post() ) {
            ...
            $image = Image::factory($picture);
            $image->resize(160, 160, Image::PRECISE);
            $image->crop(160, 160);
            $image->save(DOCROOT."upload/".$name); 
            ...
            $this->post = new Model_Post;
            $this->post->delete_post('profile_pic', $user);
            $post = $this->post->new_post('profile_pic', url::base().'upload/'.$photo->profile_pic_o, " has updated profile picture. ");
            $this->activity = new Model_Activity;
    ...
    public function action_subscription_details() {
        ...
        $this->template->title = 'Subscription Details | Amygoz';
    ...
    public function action_change_email() {
        ...
        $this->template->title = 'Change Email | Amygoz'; //Ash added
    }
    ...
    public function action_privacy_settings() {
        ...
        $this->template->title = 'Privacy Settings | Amygoz';
    }
