...
class Controller_Importapi extends Controller_Template {

    //public $template = 'templates/profile';

    //Load the contact importer page
    public $template = 'templates/peoplereviewapi'; //template file
    ...
    public function before() {
        ...
        {
            $this->template->header = View::factory('templates/peoplereviewapi'); //template header
        } else {
            $this->template->header = View::factory('templates/peoplereviewapi');
        }
    }
    ...
    public function action_invite() 
    {
        if($this->request->query())
        {
           ...
           $emails = $this->request->query('email');
           ...
           $temp_words = array();
            ...
            if(count($already) !== count($emails)) 
            {
                ...
                echo json_encode(array('status'=> 1, 'message'=> "Invitation sent successfully."));
                exit;
            ...
            if(!empty($already)) 
            {
                ...
                echo json_encode(array('status'=> 0, 'message'=> "Invitation sent successfully."));
                exit;
            }
        }
        echo "Invite your contacts to join Callitme";
        exit;
