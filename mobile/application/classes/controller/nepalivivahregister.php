...
/************************************************************************/
    ...
    public function action_profile_pic_update(){
        if($this->request->query())
        {
            ...
            $newfile = "/var/www/html/upload/$profile_pic";
            $newfile1 = "/var/www/html/upload/$profile_pic_o";
            $newfile2 = "/var/www/html/upload/$profile_pic_m";
            $newfile3 = "/var/www/html/upload/$profile_pic_s";
