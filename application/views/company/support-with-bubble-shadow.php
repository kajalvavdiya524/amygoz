...
<div class="container">
    <div class="<?php if(!Auth::instance()->logged_in()) { ?>static-pages-not bubble shadow <?php } else { ?> static-pages <?php } ?> row pos-rel"> 
            ...
            <div>
                <fieldset class="fieldset">
                    ...
                    <div class="marLeft20">
                        ...
                        <ol>
                            <li>Go to <a href"https://www.Callitme.com"> www.Callitme.com </a> and fill your information on the registration form.</li>
            ...
            <div>
                <fieldset class="fieldset">
                    ...
                    <div class="marLeft20">
                        ...
                        <ul>
                            <li>Visit <a href="www.Callitme.com"> Callitme</a> login page.</a></li>
                            <li>Enter your email address and your password.</li>
                            <li>Once you click Sign in, your account is reactivated.</li>
                        </ul>
                        
                        <p>
                            <b>If it is past 30 days from the date of deactivation you can ask a support agent to help you reactivate your account by filing a support request <a >Here</a>.</b>
                        </p>
                    </div>
                </fieldset>
            </div>
            ...
            <div>
                <fieldset class="fieldset">
                    ...
                    <div class="marLeft20">
                        ...
                        <ol>
                            <li>From the sign in page select the Forgot password? link or <a >click here</a>. </li>
                            <li>Enter your email address.</li>
                            <li>Check your email inbox.</li>
                            <li>Click the reset link in that email.</li>
                            <li>Choose a new password that you haven't used before.</li>
                        </ol>
                        <b>Still need help? <a href="<?php echo url::base().'pages/about_us?page=contact';?>">Contact Support</a>.</b>
                    </div>
                </fieldset>
            </div>
