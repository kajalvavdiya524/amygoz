...
<div class="panel panel-default">
    ...
    <ul class="list-group" id="contact-list">
        ...
        <li class="list-group-item">
            <div class="col-xs-3">
                <div class="row picbox1">
                    <?php 
                       ...
                       $photo_ima = file_exists("mobile/upload/" .$photo);
                       $photo_ima1 = file_exists("upload/" .$photo);
                    if(!empty($photo) && $photo_ima) { ?>
                    <img src="<?php echo url::base()."mobile/upload/".$friend->photo->profile_pic_s;?>" alt="<?php echo $friend->user_detail->first_name." ".$friend->user_detail->last_name; ?>" style="width:100%;height:100%;" class="img-thumbnail">
                    <?php }
                   else if(!empty($photo) && $photo_ima1) { ?>
            ...
            <div class="col-xs-9">
                <span class="name" style="font-size:14px;font-weight: 600;"><a href="<?php echo url::base().$friend->username; ?>"><?php echo $friend->user_detail->first_name." ".$friend->user_detail->last_name; ?></a></span><br/>
                <span style="font-size:13px;color: #4b4f56;">
