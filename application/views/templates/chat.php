...
<html lang="en">
    <head><title><?php echo $title; ?></title>
        ...
        <?php $description="Callitme is your personal network where you can match your single friends,review people you know, find singles around you and send requests to your crush anonymously";?>
        ...
        <?php } ?> <!-- styles needed by jScrollPane -->
        
        <link type="text/css" href="<?php echo url::base(); ?>jscrollpane/css/jquery.jscrollpane.css" rel="stylesheet" media="all"/>        <!-- the mousewheel plugin - optional to provide mousewheel support -->
                ...
                <div class="container marTop20" style="position:relative;">
                    <div class="row">
                        <?php if (isset($session_user->id) && $session_user->is_active == 0) { ?>
                            <div class="alert alert-warning" style="margin-bottom:0px;">
                                <span class="not-active-warning">
                                    <?php echo $session_user->user_detail->first_name; ?>, go to <?php echo $session_user->email; ?>
                                ...
                                <form class="dis-inline" action="<?php echo url::base() . "pages/resend_link"; ?>" method="post"><input type="hidden" name="email" value="<?php echo $session_user->email; ?>"/>
                        ...
                        <div class="sidemenu col-sm-3 marTop20" >
                            <?php if (Request::current()->action() !== 'compose') { ?>
                                <?php echo View::factory('chat/index'); ?>
                            <?php } ?>
                        </div>

                        <div class="main-content <?php if (Request::current()->controller() == 'peoplereview' && Request::current()->action() == 'compose') { ?> recommend-compose-main <?php } ?> col-sm-6 marTop20">
                            ...
                            ?>
                                        <div class="alert alert-info text-center">
                                            ...
                                            <h4 class="dis-inline marRight20">
                                                <?php echo $match_exists->match_by->user_detail->first_name; ?>
                                                thinks 
                                                <a href="<?php echo url::base() . $match_exists->match_to->username; ?>"><?php echo $match_exists->match_to->user_detail->first_name; ?>
                                                </a>
                                                is a good match for you. What do you think? 
                                            </h4>
                                    ...
                                    ?>
                                            <div class="alert alert-info text-center">
                                                ...
                                                <h4 class="in-block marRight20">
                                                    <?php echo $match_conf->match_by->user_detail->first_name; ?>
                                                    thinks 
                                                    <a href="<?php echo url::base() . $match_conf->match_with->username; ?>"><?php echo $match_conf->match_with->user_detail->first_name; ?>
                                                    </a>
                                                    is a good match for you. 
                                                    <a href="<?php echo url::base() . $match_conf->match_with->username; ?>"><?php echo $match_conf->match_with->user_detail->first_name; ?></a>
                        ...
                        <div class="col-sm-3 marTop20">
                            <?php echo View::factory('chat/sidebar'); ?>
                        </div>
