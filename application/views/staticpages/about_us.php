<div class="container">
    <div class="<?php if(!Auth::instance()->logged_in()) { ?>static-pages-not bubble shadow <?php } else { ?> static-pages <?php } ?> row">
        <div class="tabbable tabs-left">
            <!--begin tabs-->
            <ul class="nav nav-tabs col-md-3 marTop20" style="padding-right:0px;">
            ...
            <div class="tab-content col-md-8 marTop20">
                ...
                <div class="tab-pane <?php if(!Request::current()->query('page')) { ?> active <?php } ?>" id="lA">
                    <h2>
                         Callitme is a crowd powered people review network.                   
                    </h2>
                    ...
                    <hr>
                    <h3>We appreciate the feedback of following people. </h3> <br />
                    <a href="https://www.Callitme.com/rosspford">Ross Ford</a><br />
                    <a href="http://www.linkedin.com/pub/eric-giesecke/3/751/565">Eric Giesecke</a><br />
                    <a href="http://www.linkedin.com/pub/laurence-mckinney/18/3a7/262">Lawrence McKinney</a>
