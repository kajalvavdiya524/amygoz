...
<div class="panel-group marTop10" style="padding:10px"id="accordion">
  ...
  $('#get').change(function () {
    $('#call').click();
                        ...
                        <div class="col-sm-5">
                            ...
                            <p class="hb-mt-50">Spend it with someone you want to</p>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p class="quote-text center-block text-center midnight-blue-text">Great, who you want to go lunch with ? </p>
                    
                     <div class="input-group" style="display:flex;width:380px;padding-top:15px;margin-left:310px;">
            ...
            <input type="text" id="search-query1" class="required email find_user form-control" name="test" placeholder="Enter email address or name auto suggestion" required>
             <button type="button" class="btn btn-primary" id="snext" onclick="return set_data();" style="color:white;"data-toggle="collapse" data-parent="#accordion" href="#accordionThree"  >Enjoy Game</button>       
