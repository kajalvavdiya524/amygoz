			...
			<div class="user_box">
                        ...
                        <div>
                            ...
                            if (!empty($photo) && $photo_image) { ?>
                                    <img src="<?php echo url::base() . "mobile/upload/" . $member->photo->profile_pic_s ?>" alt="<?php echo $member->user_detail->first_name . " " . $member->user_detail->last_name; ?>" class="img-rounded pull-left">
                                <?php }
                            else if (!empty($photo) && $photo_image1) { ?>
                                    <img src="<?php echo url::base() . "upload/" . $member->photo->profile_pic_s ?>" alt="<?php echo $member->user_detail->first_name . " " . $member->user_detail->last_name; ?>" class="img-rounded pull-left">
                                <?php } else { ?>
