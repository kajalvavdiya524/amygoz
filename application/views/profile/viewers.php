                ...
                <div class="col-sm-6">
                    <div class="user-img pull-left">
                        <a href="<?php echo url::base().$viewer->viewer->username; ?>">
                            <?php 
                            $photo = $viewer->viewer->photo->profile_pic_s;
                            $viewer_image = file_exists("mobile/upload/" .$photo);
                            $viewer_image1 = file_exists("upload/" .$photo);
                            if(!empty($photo) && $viewer_image) { ?>
                                <img src="<?php echo url::base().'mobile/upload/'.$viewer->viewer->photo->profile_pic_s;?>">
                            <?php }
                            else if(!empty($photo) && $viewer_image1) { ?>
