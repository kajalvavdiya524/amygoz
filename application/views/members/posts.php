...
<?php foreach ($posts as $post) { 
    if($post->user->is_blocked == 0) { //check user is blocked or not ?>
        <div class="post" style="box-shadow:0 0 0 1px rgba(0,0,0,.1),0 2px 3px rgba(0,0,0,.2);background:#fefefe; border-radius: 3px 3px 0px 0px;">
            <div class="row">
                <div class="container" style="margin-top: -6px;">
                    ...
                    <div class="col-md-10" style="padding-left:14px;">
                        ...
                        <br/>
                        <span class="post-time-box" style="font-size: 12px;color: #90949c;">
                    ...
                    <div class="dropdown pull-right">
                        ...
                        <ul class="dropdown-menu" style="background-color:#ebebeb;min-width:100px;" role="menu" aria-labelledby="menu1">
                            <?php if ($post->user->id == Auth::instance()->get_user()->id) { ?>
                                ...
                                <form class="delete-post text-center" action="<?php echo url::base()."members/delete_post"?>" method="post">
                            ...
                            <?php } ?>
                            <li role="presentation">
                                <a href="<?php echo url::base()."post/".md5(sha1($post->id));?>"><button style="background:none!important;border:none;cursor:pointer;width: 100px;" type="submit">View Post</button></a>                                
                            </li>
                            <li role="presentation">
                                <?php $post_url = url::base()."post/".md5(sha1($post->id)); ?>
                                <button style="background:none!important;border:none;cursor:pointer;width: 145px;" id="copyPostURL" type="submit" onclick="copyPostURL('<?php echo $post_url;?>')">Copy Link</button>                               
                            </li>
                            <li role="presentation">
                                <button style="background:none!important;border:none;cursor:pointer;width: 145px;" type="submit" onclick=openShareDialog(<?php echo $post->id;?>)>Share</button>
                            </li>
                        </ul>
                    </div> 
                    ...
                    <div id="postModal<?php echo $post->id; ?>" class="modal" style="z-index: 9999;">
                        <div class="modal-content" style="width: 30%;height: 50%;left: 35%;top: 25%;">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <?php $name = $post->user->user_detail->first_name ." ".$post->user->user_detail->last_name;
