                                                        ...
                                                        <table class="left" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="line-height:0;">
                                                                    <a target="_blank" style="text-decoration:none;" href="<?php echo url::base();?>"><img src="https://www.amygoz.com/img/amygoz.png" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left" vspace="0" hspace="0" width="113" alt="Amygoz Logo" /></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </th>
                                    ...
                                    <tr>
                                        <td data-bgcolor="bg-block" class="holder" style="padding:8px 60px 52px;" bgcolor="#f9f9f9">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                               ...
                                               <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/5px Arial, Helvetica, sans-serif; color:#888; padding:0 0 18px;">
                                                        <p style="margin:0;word-wrap:break-word;color:none;word-break:break-word;font-weight:400;font-size:15px;line-height:1.429;font:15px/25px Arial;">This is a reminder to let you know that your account is still not activated. To enjoy the full features, you must activate your account.</p>    
                                                    </td>      
                                                </tr>
                                                <tr>
                                                    <td style="padding:0 0 20px;">
                                                        <table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#00bcd4; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
                                                                    <a target="_blank" style="text-decoration:none; color:#00bcd4; display:block; padding:12px 10px 10px;" href="<?php echo $link; ?>">Activation link</a>
                                                                </td>
                                                            </tr>                                                            
                                                        </table>
                                                    </td>
