                                ...
                                <table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td data-bgcolor="bg-block" class="holder" style="padding:8px 60px 52px;" bgcolor="#f9f9f9">
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/20px Arial, Helvetica, sans-serif; color:#888; padding:0 0 18px;">       
                                                     This is a confirmation mail for your request to change your account's email address.
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/20px Arial, Helvetica, sans-serif; color:#888; padding:0 0 18px;">       
                                                       Please <a href="<?php echo $link;?>" target="_blank">click here </a> to confirm.
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
