...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty brd-pag-2">
      <tr>
        ...
        <img src="https://www.amygoz.com/img/amygoz.png" alt="Amygoz Logo" style="position: relative;top:0px;height: 37px;padding: 0px 0px 0px 25px;"/>
        </a>
            </td>
      <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
        ...
        <td style="width: 49px;vertical-align: middle;">                                            
                ...
                <img alt="" src="https://m.amygoz.com/upload/<?php echo $user->photo->profile_pic;?>" style="width: 35px;height: 35px;border-radius: 50%;padding: 0px 2px 0px 0px;">
                <?php } else { ?>
        ...
        <ul class="list-pad col-xs-12" style="list-style-type: none;">
          <li class="unline-list" style="list-style-type: none;padding: 0px 6px 0px 0px;">                                       
                ...
                <?php 
                 ...
                 if ($viewer->viewer->photo->profile_pic) { ?>
                <img alt="" src="https://m.amygoz.com/upload/<?php echo $viewer->viewer->photo->profile_pic;?>" style="width: 50px;height: 50px;border-radius: 50%;float: left;">
                <?php } 
                else if (!empty($photo)&& $viewer2) { ?>
                <img alt="" src="https://www.amygoz.com/upload/<?php echo $viewer->viewer->photo->profile_pic;?>" style="width: 50px;height: 50px;border-radius: 50%;float: left;">
                <?php } else { ?>
                 <img alt="" src="https://m.amygoz.com/img/no_image_m.png" style="width: 50px;height: 50px;border-radius: 50%;float: left;">
                <?php } ?>
                </a>                                                                   
...
<br/><br/>
        <table class="sprty">
            <tr style="text-align: center;">
              <td style="text-align: center;">                                               
          <p style="font-size:15px;color:#888;text-align: center;">
                Please <a href="<?php echo url::base()."pages/redirect_to/".$user->username ."?page=".urlencode("profile/viewers"); ?>" style="color: #00bcd4;text-decoration:none;"> login to your account </a> to see who else has viewed your profile.
                            </p>
                        </td>
                    </tr>
                </table> 
