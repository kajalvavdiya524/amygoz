                                                                   ...
                                                                   <td style="padding-left:5px;flote:right;padding-left:5px;" width="10" valign="middle">
                                                                    <?php 
                                                                     ...
                                                                     $photo_image1 = file_exists("upload/".$photo);
                                                                       ...
                                                                       <img alt="" src="https://m.callitme.com/upload/<?php echo $newemail->photo->profile_pic;?>" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none;display:block" class="CToWUd" width="40" border="0" height="40">
                                                                      <?php }  else { ?>
                                                                    ...
                                                                    <td valign="top" style="padding:0 25px 0 0"> 
                                                                        <a href="<?php echo url::base() . "pages/redirect_to/" ."?page=" . urlencode($sess_us->username); ?>">  
                                                                              <?php 
                                                                                 ...
                                                                                 $photo_image1 = file_exists("upload/".$photo);*/
                                                                                   if($sess_us->photo->profile_pic) { ?>
                                                                                   <img alt="" border="0" height="70" width="70" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none" class="CToWUd" src="https://m.callitme.com/upload/<?php echo $sess_us->photo->profile_pic;?>">
                                                                                  <?php } else { ?>
