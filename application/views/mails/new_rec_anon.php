                                                                   ...
                                                                   <td style="padding-left:5px;flote:right;padding-left:5px;" width="10" valign="middle">
                                                                    <?php 
                                                                     ...
                                                                     $photo_image1 = file_exists("upload/".$photo);
                                                                       ...
                                                                       <img alt="" src="<?php echo url::base().'upload/'.$user_to->user->photo->profile_pic;?>" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none;display:block" class="CToWUd" width="40" border="0" height="40">
                                                                      <?php }  else { ?>
                                                                        <td style="padding-left:10px;background-color: #fff;width:30px;height:30px;border-radius:50%">
                                                                            <font style="font-size:150%;"><?php echo ucwords($user_to->first_name[0])."".ucwords($user_to->last_name[0]);?></font>
                                                                      </td>        
                                                                    <?php } ?>
                                                                </td><td width="1">&nbsp;</td>
                                                            </tr>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/5px Arial, Helvetica, sans-serif; color:#888; padding:0 0 15px;">
                                                        <p>Hi <?php echo $user_to->first_name;?>,<p>
                                                                ...
                                                                <tr> 
                                                                    <td valign="top" style="padding:0 25px 0 0"> 
                                                                        <a target="_blank" href="<?php echo url::base();?>">   
                                                                            <img alt="" border="0" height="70" width="70" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none" class="CToWUd" src="<?php echo url::base().'img/images.jpg';?>"></p> 
                                                                        </a>    
                                                                    </td>
                                                ...
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                                        Please log in to your <a href="<?php echo url::base()."pages/redirect_to/".$user_to->user->username ."?page=".urlencode("peoplereview"); ?>"
                                                        style="color: #01BF01;text-decoration:none;"> Callitme. </a> 
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">
                                                    ...
                                                    <th class="thead" width="100%" align="left" style="vertical-align:top; padding:0;">
                                                        <table class="center" align="left" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                ...
                                                                <td width="20"></td>
                                                                <td class="btn" valign="top" style="line-height:0; padding:3px 0 0;">
                                                                    <a target="_blank" style="text-decoration:none;" href="https://twitter.com/call_it_me"><img src="h<?php echo url::base();?>/img/icon/twitter.png" border="0" style="font:12px/15px Arial, Helvetica, sans-serif; color:#797c82;" align="left" vspace="0" hspace="0" width="20" height="20" alt="twitter" /></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </th>
