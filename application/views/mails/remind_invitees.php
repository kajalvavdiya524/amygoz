    ...
    <table class="sprty brd-pag-2">
      <tr>
        ...
        <table class="sprty">
            ...
            Hello,<!--name of recipet user--><br/> I am still waiting for you to connect with me on Callitme.
                </p>
            </td>
          </tr>
        </table> 
        <table class="sprty">
            <tr>
              <td>
              <p style="font-size:15px;color:#888;padding: 10px 25px 0px 30px;">
           Please join and write good words for your good friend.
                </p>
            </td>
          </tr>
        </table>     
        ...
        <table class="sprty" style="text-align: center;">
            ...
            <a target="_blank" href="<?php echo url::base().$invite->by->username; ?>" style="padding:9px 35px;background:#00bcd4;color:#fff;">
            View my profile
                    </a>
                </td>
              </tr>
