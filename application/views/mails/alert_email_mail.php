...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty">
        ...
        You have requested to change your Callitme account's email address.
           </p>
        </td>
        </tr>
    ...
    <tr>
     <td> 
       <p style="color:#00bcd4; font-size:15px;padding: 2px 25px 4px 30px;">                                                         
        Your new email is - <?php echo $new_email;?>
        </p>
       </td>
      </tr>
    ...
    <tr>
     <td> 
       <p style="color:#888; font-size:15px;padding: 4px 25px 35px 30px;">                                                   
        If you didn't request to change your email address, please ignore this email and 
        <a href="<?php echo url::base()."pages/contact_us";?>" style="color: #00bcd4;text-decoration:none;">
        contact our support team </a>if you need any help.
        </p>
       </td>
      </tr>
     </table>
