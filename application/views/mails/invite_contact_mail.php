...
@media only screen and (max-width: 768px) {
    ...
    <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
       ...
       <td style="width: 49px;vertical-align: middle;">                                                         
        ...
        <?php }  else { ?>
        <span style="background-color:#bdbcbc;border-radius:50%;padding:7px;font-size:18px;margin:0px auto;text-align:center;">
        ...
        Hi ,<br/><br/>
        <span style="color:#888; font-size:15px;padding: 0px 25px 2px 30px;">
        I want to invite you to join Callitme. On Callitme you can review your friends and increase their social percentile. You can also invite your friends for a dinner or your crush out for a date anonymously.
  ...
  <table class="sprty">
    <tr>
      <td class="row">
        ...
        <a href="<?php echo url::base()."pages/redirect_to/".$user_to->username ."?page=".urlencode($user->username); ?>" style="text-decoration:none; color:#00bcd4;">
        <?php 
       ...
       <?php echo $from->user_detail->first_name[0]."".$from->user_detail->last_name[0];?> 
        ...
        <li class="unline-list" style="list-style-type: none;">
            <p class="text-sharp posh-ytr" style="font-weight:500;font-size: 13px;">
              ...
              <br/>  
        <?php echo ucwords($user->user_detail->location); ?>
        <br/>
        ...
        <table class="sprty">
           <tr>
              <td>
              <span style="color:#888; font-size:15px;padding:25px 25px 2px 30px;">
                   Please join and write few good words for me.
                   </span>
            </td>
          </tr>
      </table>
<br/><br/>
    <table class="sprty" style="text-align: center;">
        <tr>
          <td>
            <p style="color:#888; font-size:15px;text-align: center;padding: 2px 0px 2px 0px;">
        <a href="<?php echo url::base()."pages/redirect_to/".$user_to->username ."?page=".urlencode($user->username); ?>" style="text-decoration:none; color:#00bcd4;">
        View my Callitme Profile & Review Me
                </a>
            </p>
        </td>
    </tr>
...
<br/><br/>
      <table class="sprty">
        <tr>
          <td>
        <p style="color:#888; font-size:16px;font-weight:500;padding: 2px 25px 2px 30px;">Thank You,</p>
        </td>
      </tr>
    </table>
<br/><br/>
       <table class="sprty">
        ...
        <small style="text-align: center;">You are receiving this message because you are a member of Callitme. You can manage your email subscription preferences <a href="<?php echo $unsubsribe_url;?>">here</a>
        </small>
          </p>
                </td>
              </tr>
