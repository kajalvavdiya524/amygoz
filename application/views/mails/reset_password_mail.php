      ...
      <tr>
       ...
       <table class="sprty">
        ...
        Please click on the link below to reset your password. 
         ...
         <tr>
            <td>                                               
                <p style="color:#888; font-size:15px;padding: 5px 25px 0px 30px;word-break: break-all;">                                               
        ...
        <tr>
            <td>                                               
                <p style="color:#888; font-size:15px;padding: 5px 25px 35px 30px;">                                                
        If the link above doesn't work, please copy and paste the link in the 'Address' bar of your browser.
         </p>
          </td>
          </tr>                                          
          </table>                                          
