  ...
  <table class="sprty">
      ...
      <td class="row">
        <ul class="list-pad col-xs-12" style="list-style-type: none;">
          ...
          <a href="<?php echo url::base() . "pages/redirect_to/" ."?page=" . urlencode($from->username); ?>">  
           ...
           <img alt="<?php echo $from->user_detail->first_name." ".$from->user_detail->last_name;?>" src="https://m.callitme.com/upload/<?php echo $from->photo->profile_pic;?>" style="width: 50px;height: 50px;border-radius: 50%;float: left;">
         <?php } else { ?>
        ...
        <?php } ?>
         ...
         <a style="font:16px/25px Arial, Helvetica, sans-serif;color:#888;text-decoration: none;" href="<?php echo url::base() . "pages/redirect_to/" ."?page=" . urlencode($from->username); ?>"><?php echo $from->user_detail->first_name." ".$from->user_detail->last_name; ?>
            ...
            <br/>                                                   
              ...
              $percentile_s= $from->friends->calculate_social_percentage($tags);
              ?>
    ...
    <tr>
      <td class="row">
        ...
        <img alt="" src="https://m.callitme.com/upload/<?php echo $friend->photo->profile_pic;?>" style="width: 50px;height: 50px;border-radius: 50%;float: left;">
        <?php } else { ?>
        <span style="padding-left:10px;background-color:#bdbcbc;border-radius:50%;padding:16px;font-size:21px;margin:0px auto;text-align:center;float: left;">
