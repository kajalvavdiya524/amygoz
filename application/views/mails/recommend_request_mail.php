                                                        ...
                                                        <table class="" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="color:#fff; flote:right">
                                                                   <?php echo ucwords($to->first_name.' '.$to->last_name);?>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </th>
                                                        ...
                                                        <table class="" cellpadding="4" cellspacing="0">
                                                            <tr>
                                                                   <td style="padding-left:5px;flote:right;padding-left:5px;" width="10" valign="middle">
                                                                    <?php 
                                                                     $photo = $to->user->photo->profile_pic;
                                                                     $photo_image1 = file_exists("upload/".$photo);
                                                                       if(!empty($photo)&& $photo_image1) { ?>
                                                                       <img alt="" src="<?php echo url::base().'upload/'.$to->user->photo->profile_pic;?>" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none;display:block" class="CToWUd" width="40" border="0" height="40">
                                                                      <?php }  else { ?>
                                                                        <td style="padding-left:10px;background-color: #fff;width:30px;height:30px;border-radius:50%">
                                                                            <font style="font-size:150%;"><?php echo ucwords($to->first_name[0])."".ucwords($to->last_name[0]);?></font>
                                                                      </td>        
                                                                    <?php } ?>
                                                                </td><td width="1">&nbsp;</td>
                                                            </tr>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/5px Arial, Helvetica, sans-serif; color:#888; padding:0 0 15px;">
                                                        <p>Hi <?php echo $to->first_name;?>,<p>
                                                        <p style="margin:0;word-wrap:break-word;color:none;word-break:break-word;font-weight:400;font-size:14px;line-height:1.429;font:13px/25px Arial">
                                                          <?php echo $from->user_detail->first_name." ".$from->user_detail->last_name;?> requested for a review from you in callitme. 
                                                       </p>
                                                    <td>
                                                </tr>
                                                <tr>
                                                            ...
                                                            <tbody> 
                                                                <tr> 
                                                                    <td valign="top" style="padding:0 25px 0 0"> 
                                                                        <a href="<?php echo url::base() . "pages/redirect_to/" ."?page=" . urlencode($from->username); ?>">  
                                                                                <?php 
                                                                                    ...
                                                                                    <img alt="" border="0" height="70" width="70" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none" class="CToWUd" src="<?php echo url::base().'mobile/upload/'.$from->photo->profile_pic;?>">
                                                                                    <?php } 
                                                                                    else if(!empty($photo)&& $photo_image1) { ?>
                                                                                    <img alt="" border="0" height="70" width="70" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none" class="CToWUd" src="<?php echo url::base().'upload/'.$from->photo->profile_pic;?>">
                                                                                    <?php } else { ?>
                                                                    ...
                                                                    <td valign="top" width="100%">
                                                                        ...
                                                                        <p data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 2px;"> Could you do me a favor by 
                                                                       <a href="<?php echo url::base()."pages/redirect_to/".$to->user->username ."?page=".urlencode("peoplereview/recommend_request"); ?>" 
                                                                       style="color: #01BF01;text-decoration:none;">
                                                                       reviewing me </a> in Callitme? Your review about me would affect my Social Percentile.</p>  
                                                                       <p data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 2px;">
                                                                       Please <a href="<?php echo url::base()."pages/redirect_to/".$to->user->username ."?page=".urlencode("peoplereview/recommend_request"); ?>" 
                                                                        style="color: #01BF01;text-decoration:none;">
                                                                        click here to review me.</a> </p>
                                                                    </td>  
                                                                </tr> 
                                                            </tbody> 
                                                        </table>
