    ...
    <table class="sprty brd-pag-2">
     ...
     <table>
      ...
      <tr>
          <td>
          <p style="color:#888; font-size:15px;padding: 2px 25px 0px 30px;">                                              
        First name: <?php echo isset($data['first_name']) ? $data['first_name'] : '' ;?>
        </p>
       </td>
     </tr>
     ...
     <tr>
          <td>
          <p style="color:#888; font-size:15px;padding: 2px 25px 0px 30px;">                                                      
        Last name: <?php echo isset($data['last_name']) ? $data['last_name'] : '' ;?> 
        </p>
       </td>
     </tr>
      ...
      <tr>
          <td>
          <p style="color:#888; font-size:15px;padding: 2px 25px 0px 30px;">                                                    
        Phone: <?php echo isset($data['phone']) ? $data['phone'] : '' ;?>
        </p>
       </td>
     </tr>
       ...
       <tr>
        ...
        Location: <?php echo isset($data['location']) ? $data['location'] : '' ;?>
        </p>
       </td>
     </tr>
    </table>
