...
@media only screen and (max-width: 768px) {
    ...
    <body>
      ...
      <tr>
        ...
        This is a mail from <?php echo $first_name." ".$last_name; ?>,
        </p>
            </td>
          </tr> 
        ...
        <tr>
          <td>
            <p style="color:#888; font-size:15px;padding: 2px 25px 0px 30px;">                                                   
        Issue Type -  <?php  $detail = Kohana::$config->load('profile')->get('issues'); echo ($issue) ? $detail[$issue] : "--";?>
        </p>
            </td>
          </tr>
        ...
        Message as follows:  <?php echo $message;?>
        </p>
            </td>
          </tr>
          </table>
