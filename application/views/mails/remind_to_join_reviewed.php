                                                        ...
                                                        <table class="left" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="line-height:0;">
                                                                    <a target="_blank" style="text-decoration:none;" href="<?php echo url::base();?>"><img src="https://m.callitme.com/img/logo1.png" border="0" style="font:bold 12px/12px Arial, Helvetica, sans-serif; color:#606060;" align="left" vspace="0" hspace="0" width="113" alt="CALLITME.COM" /></a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </th>
                                                                   ...
                                                                   <td style="padding-left:5px;flote:right;padding-left:5px;" width="10" valign="middle">
                                                                    <?php 
                                                                     ...
                                                                     $photo_image2 = file_exists("upload/".$photo);*/
                                                                       ...
                                                                       <img alt="" src="https://m.callitme.com/upload/<?php echo $user->photo->profile_pic;?>" style="border-radius:50%;outline:none;color:#ffffff;text-decoration:none;display:block" class="CToWUd" width="40" border="0" height="40">
                                                                      <?php } else { ?>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                               <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/5px Arial, Helvetica, sans-serif; color:#888; padding:0 0 18px;">
                                                        <p style="margin:0;word-wrap:break-word;color:none;word-break:break-word;font-weight:400;font-size:14px;line-height:1.429;font:13px/25px Arial;">Hi,<br/>
                                                          Did you read the review I wrote for you? 
                                                            <a href="<?php echo url::base()."pages/redirect_to/".$user->username ."?page=".urlencode("peoplereview"); ?>"
                                                                style="color: #00bcd4;text-decoration:none;"> Read what I wrote about you. 
                                                            </a>.
                                                        </p>    
                                                    </td>      
                                                </tr>
