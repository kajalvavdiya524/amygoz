                                                        ...
                                                        <table class="" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="color:#fff; flote:right">
                                                                   <?php echo ucwords($newemail->user_detail->first_name.' '.$newemail->user_detail->last_name);?>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </th>
                                                                     ...
                                                                     $photo_image1 = file_exists("upload/".$photo);
                                                                      ...
                                                                      <?php }  else { ?>
                                                                        <td style="padding-left:10px;background-color: #fff;width:30px;height:30px;border-radius:50%">
                                                                            <font style="font-size:150%;"><?php echo ucwords($newemail->user_detail->first_name[0])."".ucwords($newemail->user_detail->last_name[0]);?></font>
                                                                      </td>        
                                                                    <?php } ?>
                                                                </td><td width="1">&nbsp;</td>
                                                            </tr>
                                            ...
                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/5px Arial, Helvetica, sans-serif; color:#888; padding:0 0 15px;">
                                                        <p>Hi <?php echo $newemail->user_detail->first_name;?>,<p>
                                                        <p style="margin:0;word-wrap:break-word;color:none;word-break:break-word;font-weight:400;font-size:14px;line-height:1.429;font:13px/25px Arial"><?php echo ucwords($from->user_detail->first_name." ".$from->user_detail->last_name);?> has uploaded a new photo on Callitme.</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>           
                                                            ...
                                                            <tbody> 
                                                                <tr> 
                                                                    ...
                                                                    <td valign="top" width="100%">
                                                                        ...
                                                                        <p data-color="text" data-size="size text" data-min="10" data-max="26" data-link-color="link text color" data-link-style="font-weight:bold; text-decoration:underline; color:#40aceb;" align="left" style="font:16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px;">As you requested, I have uploaded my profile picture. Please check it out. I hope you like it.</p>  
                                                                    </td>  
                                                                </tr> 
                                                            </tbody> 
                                                        </table>
                                                        ...
                                                        <table width="134" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td data-bgcolor="bg-button" data-size="size button" data-min="10" data-max="16" class="btn" align="center" style="font:12px/14px Arial, Helvetica, sans-serif; color:#f8f9fb; text-transform:uppercase; mso-padding-alt:12px 10px 10px; border-radius:2px;" bgcolor="#7bb84f">
                                                                    <a target="_blank" style="text-decoration:none; color:#f8f9fb; display:block; padding:12px 10px 10px;" href="<?php echo url::base()."pages/redirect_to/$username". "?page=".urlencode($username);?>">Check it out</a>
                                                                </td>
                                                            </tr>                                                            
                                                        </table>
                                                    </td>
