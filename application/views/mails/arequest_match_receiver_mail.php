...
@media only screen and (max-width: 768px) {
    ...
    <body>
      ...
      <table class="sprty">
        ...
        <a href="<?php echo url::base()."pages/redirect_to/".$to->username ."?page=".urlencode($owner->username); ?>" style="color: #01BF01;text-decoration:none;">
        Why wait? <br/>log in</a> to your account and get in touch with <a href="<?php echo url::base()."pages/redirect_to/".$to->username ."?page=".urlencode($owner->username); ?>" style="color: #01BF01;text-decoration:none;">
      ...
      <p style="word-break: break-all;text-align: center;">                                                     
       <small style="text-align: center;word-break: break-all;">You are receiving this message because you are a member. You can manage your email subscription preferences <a href="<?php echo url::base();?>/account/email_notification_settings">here</a>
                </small>
                </p>
              </td>
            </tr>
