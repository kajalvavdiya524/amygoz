...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty brd-pag-2">
      <tr>
        ...
        $user2 = file_exists("upload/".$photo);*/
        ...
        <?php } else { ?>
        <span style="padding-left:10px;background-color:#bdbcbc;border-radius:50%;padding:8px;font-size:20px;margin:0px auto;text-align:center;">
      ...
      <table class="sprty">
        ...
        Hi <?php echo $user->user_detail->first_name; ?>,    
         ...
         <tr>
        <td>                                               
          <p style="color:#888; font-size:15px;padding: 2px 25px 0px 30px;">                                              
        Do you have a crush on someone? We all did. Invite your crush for a casual lunch. Don’t worry, 
        <?php echo ($user->user_detail->sex == 'Female' ? 'he' : 'she' ); ?> will not know 
        who you are if <?php echo ($user->user_detail->sex == 'Female' ? 'he' : 'she' ); ?> is not interested in having lunch with you.
        </p>
         </td>
         </tr> 
        ...
        <tr style="text-align: center;">
            <td style="text-align: center;">
             <p style="color:#888; font-size:15px;padding: 25px 0px 35px 0px;">                                          
        <a style="text-decoration:none; color:#fff;background: #00bcd4;padding: 9px 38px;" href = "<?php echo url::base()."pages/redirect_to/".$user->username."?page=activity"; ?>">
        Invite your crush
        </a>
        </p>
        </td>
