    ...
    <table class="sprty brd-pag-2">
      <tr>
       ...
       <table class="sprty">
        ...
        <?php echo $match->match_by->user_detail->first_name." ".$match->match_by->user_detail->last_name; ?> thinks
                </p>
            </td>
          </tr>
        ...
        <?php echo $match->match_with->user_detail->first_name; ?> is a good match for you.
                </p>
            </td>
          </tr>
         ...
         <tr>
          <td>
            <p style="color:#888; font-size:15px;padding: 2px 25px 0px 30px;">                                                  
        <?php echo $match->match_with->user_detail->first_name; ?> also agrees with 
                                                           
        <?php echo $match->match_by->user_detail->first_name; ?>. What do you think?
                </p>
            </td>
          </tr>
        ...
        <tr>
          <td>
            <p style="color:#888; font-size:15px;padding: 2px 25px 35px 30px;">                                                  
        Please login to your <a href="<?php echo url::base();?>" style="text-decoration:none; color:#00bcd4;">Callitme</a> account to view the request.
                </p>
             </td>
           </tr>
          </table>
