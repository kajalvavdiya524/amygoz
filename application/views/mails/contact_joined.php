...
@media only screen and (max-width: 768px) {
    ...
    <table class="sprty">
        ...
        Your contact
        <a href="<?php echo url::base()."pages/redirect_to/".$invite->by->username ."?page=".urlencode($invite->to->username); ?>" style="text-decoration:none; color:#00bcd4;"> 
        <?php echo $invite->to->user_detail->get_name(); ?>
        </a>, just joined Callitme.
        </p>
        </td>
        </tr>
       ...
       <tr>
            <td>                                               
          <p style="color:#888; font-size:15px;padding: 10px 25px 35px 30px;">                                                    
