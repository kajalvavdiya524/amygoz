...
@media only screen and (max-width: 768px) {
    ...
    <td style="text-align:right;padding-right:5px;vertical-align: middle;"> 
      ...
      <table class="sprty">
        ...
        <span style="color: #00bcd4;font-size:15px;font-weight: 500;">Welcome to Callitme</span> This is a reminder to let you know that your Callitme account is still not activated. To enjoy the full features of Callitme, you must activate your account.
        </p>
      </td>
    </tr>
       ...
       <tr>
        ...
        <a href="<?php echo $link; ?>" style="color: #00bcd4;text-decoration:none;">Activation link</a>
        </p>
      </td>
    </tr>
  </table>  
