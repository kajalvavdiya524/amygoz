                        ...
                        <div class="col-xs-3">
                            <div class="row picbox1">
                                ...
                                if (!empty($photo) && $fri_image) { ?>
                                    <img src="<?php echo url::base() . "mobile/upload/" . $friend->photo->profile_pic_s; ?>" alt="<?php echo $friend->user_detail->first_name . " " . $friend->user_detail->last_name; ?>" class="img-thumbnail" style="width:100%; height:100%;">
                                <?php }
                                else if (!empty($photo) && $fri_image1) { ?>
                                    <img src="<?php echo url::base() . "upload/" . $friend->photo->profile_pic_s; ?>" alt="<?php echo $friend->user_detail->first_name . " " . $friend->user_detail->last_name; ?>" class="img-thumbnail" style="width:100%; height:100%;">
                                <?php } else { ?>
