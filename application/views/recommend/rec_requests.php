...
<div class="scroll-sec recommendations-block">
    ...
    <div class="recommendations">
                ...
                <div class="collapse-header">
                    <div class="user-img pull-left">
                        <a href="<?php echo url::base().$request->owner->username; ?>">
                            <?php 
                            $photo = $request->owner->photo->profile_pic_s;
                            $rec_image = file_exists("mobile/upload/" .$photo);
                            $rec_image1 = file_exists("upload/" .$photo);
                            if(!empty($photo) && $rec_image) { ?>
                                <img src="<?php echo url::base().'mobile/upload/'.$request->owner->photo->profile_pic_s;?>">
                            <?php }
        ...
        <?php } else { ?>
            <h3 class="textCenter">No one has requested a review from you.</h3>
        <?php } ?>
    </div>
</div>