...
class Controller_Members extends Controller_Template {
    ...
    public function before() {
        ...
        if(!$this->request->is_ajax()) {
            ...
            $this->template->description = 'Find meet and get inspired by great people in Amygoz';
    ...
    public function action_index() {
        ...
        if(!$this->request->is_ajax()) {
            ...
            // if ajax show posts for pagination
    ...
    public function action_view_post() {
        ...
        echo View::factory('members/view_post', $data);
    }
    ...
    public function action_post_detail() {   
        ...
        $this->template->content = View::factory('members/post_detail', $data);
    }
    ...
    public function action_add_comment() {
        ...
        if($this->request->post('comment')) {
            ...
            echo View::factory('members/new_comment', array('comment' => $comment));
        }
 ...
 /*  public function action_search() { 
    ...
    */
        ...
        if ($this->request->query('term')) {
            ...
            foreach($users as $user) {
                ...
                if(!empty($user->user_detail->location)) {
                    ...
                    $temp['location'] = 'San Francisco, CA, United States';
                }
    ...
    public function action_invite_find_userTEST() 
    {
        $this->auto_render = false;
        if ($this->request->query('query')) 
        {
   ...
   public function action_invite_find_user() {
    ...
    public function action_profile() {
        ...
        $activity_data = ORM::factory('activity')
            ->where(DB::expr("DATE(time)"), '=', $current_date)
        ...
        $this->template->description = 'View ' . $name . '\'s full profile on Amygoz. Amygoz helps people like you and ' . $name . ' find new friends and meet trusted people online. Find ' . $name . '\'s  friends, family, education, school, job and reviews.';
    ...
    public function action_activity_notification() {
        if($this->request->is_ajax()) {
            ...
            if($this->request->query('seen')) {
                ...
                echo View::factory('members/activities', array('activities' => $activities))->render();
            }
        }
    }
    ...
    public function action_match() {
        ...
        if($this->request->post()) {
            ...
            //send email
                    ...
                    $send_email = Email::factory($user->user_detail->first_name . ' has a match for you')
                        ->message(View::factory('mails/new_match_mail', array('match' => $match,'user_with'=>$user_with))->render(), 'text/html')
                        ->to($user_with->email)
        ...
        public function action_matchWithName() {
        $user = Auth::instance()->get_user();
    ...
    public function action_accept_match() {
        ...
        if($match->id) {
            ...
            if($match->with == $user->id) {
                ...
                if($status == 'accept') {
                    //send email
                    $send_email = Email::factory('Amygoz - '.$user->user_detail->first_name . ' has a match for you')
