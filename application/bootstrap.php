...
if (empty($_SERVER['HTTP_HOST'])) {
	...
	Route::set('default', '(<controller>(/<action>(/<id>(/<page>))))', array('controller' => '(messageapi|accessapi|nepalivivahregister|cron|pages|company|careers|matchsingles|socialdating|pp)'))
		->defaults(array(
			'controller' => 'pages',
			'action'     => 'index',
		)
	...
	Route::set('main', '(<controller>(/<action>(/<id>(/<page>))))', array('controller' => '(messageapi|accessapi|nepalivivahregister|upgrade|company|members|friends|profile|messages|peoplereview|localpeople|pages|import|activity|admin|careers|pp|cron|chat)'))
		->defaults(array(
			'controller' => 'members',
			'action'     => 'index',
		)
