...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="content">
         <!-- Main content -->
          ...
          <div class="row">
		  <div class="box">
		  <a class="btn btn-info pull-right" href="index.php?p=education&a=add"> Add New Record</a>
	  </div>
            <div class="col-xs-12">
			 <?php 
			if($str!="")
           ...
           <a href="#" class="alert-link"><?php  echo $str;?></a>
			...
			<?php for($i=0;$i<count($res);$i++)
					 ...
					 <td> <?php echo $res[$i]['Id']; ?></td>
					  <td> <?php echo $res[$i]['Value']; ?></td>
					   ...
					   <?php if($res[$i]['Status']=='Y')
								{?>
							    <a class="btn btn-success"href="../model/education.php?a=update&status=N&id=<?php echo $res[$i]['Id']; ?>"title="Click to IN-Active Mode"><i class="fa fa-check"></i></a>
								<?php }?>
								<?php
								if($res[$i]['Status']=='N')	
								{?>
									<a class="btn btn-danger"  href="../model/education.php?a=update&status=Y&id=<?php echo $res[$i]['Id']; ?>" title="Click to Active Mode"><i class="fa fa-hand-pointer-o"></i></a>
								<?php }?>
						</td>
					   <td>
					   <a class="btn btn-success" href="index.php?p=education&a=edit&id=<?php echo $res[$i]['Id']; ?>"><i class="fa fa-edit"></i></a>
					   <a class="btn btn-danger"  href="../model/education.php?a=delete&id=<?php echo $res[$i]['Id']; ?>"><i class="fa  fa-remove"></i></a>
					   </td>
                      </tr>
					  <?php }?>
                     </tbody>
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Enter Details For Education </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../model/education.php">
				...
				// print_r($res);
				  ...
				  <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Details For Education </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../model/education.php">
