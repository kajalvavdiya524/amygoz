...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="content">
         <!-- Main content -->
          ...
          <div class="row">
		   <div class="box">
	<a class="btn btn-info pull-right" href="index.php?p=issues&a=add"> Add New Record</a>
	</div>
            <div class="col-xs-12">
           ...
           <a href="#" class="alert-link"><?php  echo $str;?></a>
			...
			?>
					 ...
					 <td> <?php echo $res[$i]['Id']; ?></td>
					  <td> <?php echo $res[$i]['Value']; ?></td>
					   ...
					   <?php if($res[$i]['Status']=='Y')
								{?>
									<a class="btn btn-success" href="../model/issues.php?a=update&status=N&id=<?php echo $res[$i]['Id']; ?> "title="Click to IN-Active Mode"><i class="fa fa-check"></i></a>
								<?php }?>
								<?php
								if($res[$i]['Status']=='N')	
								{?>
									<a class="btn btn-danger" href="../model/issues.php?a=update&status=Y&id=<?php echo $res[$i]['Id']; ?>" title="Click to Active Mode"><i class="fa fa-hand-pointer-o"></i></a>
								<?php }?>
						</td>
					   <td>
					   <a class="btn btn-success" href="index.php?p=issues&a=edit&id=<?php echo $res[$i]['Id']; ?>"><i class="fa fa-edit"></i></a>
					   <a class="btn btn-danger" href="../model/issues.php?a=delete&id=<?php echo $res[$i]['Id']; ?>" ><i class="fa  fa-remove"></i></a>
					   </td>
                      </tr>
					  <?php }?>
                     </tbody>
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Enter Details For Issues </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
				...
				// print_r($res);
				  ...
				  <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Details For Issues  </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../model/diet.php">
