...
if($msg==1)
{
  ...
  $str="Incorrect Username Or Password Please Try Again";
    ...
    <div class="login-box">
      ...
      <?php  echo $str;?>
        ...
        <form action="../script/login.php" method="post">
          ...
          <div class="form-group has-feedback">
            <input type="password" class="form-control" name="Password" placeholder="Password" required minlength="5" pattern=".{5,}"title= "Minimum 5 charecter">
