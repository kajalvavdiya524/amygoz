      ...
      <div class="content">
         <!-- Main content -->
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
            <a class="btn btn-info pull-right" href="index.php?p=religion&a=add"> Add New Record</a>
	  </div>			  
		 <?php 
			if($str!="")
		 { ?>
					 ...
					 <td> <?php echo $res[$i]['Id']; ?></td>
					  ...
					  <td> 
					   <?php if($res[$i]['Status']=='Y')
								{?>
									<a class="btn btn-success" href="../model/religion.php?a=update&status=N&id=<?php echo $res[$i]['Id']; ?>" title="Click to IN-Active Mode"><i class="fa fa-check"></i></a>
								<?php }?>
								<?php
								if($res[$i]['Status']=='N')	
								{?>
									<a class="btn btn-danger" href="../model/religion.php?a=update&status=Y&id=<?php echo $res[$i]['Id'];?>" title="Click to Active Mode"><i class="fa fa-hand-pointer-o"></i></a>
								<?php }?>
						</td>
					   <td>
					   <a class="btn btn-success" href="index.php?p=religion&a=edit&id=<?php echo $res[$i]['Id']; ?>"><i class="fa fa-edit"></i></a>
					   <a class="btn btn-danger" href="../model/religion.php?a=delete&id=<?php echo $res[$i]['Id']; ?>" title="Click to Active Mode"><i class="fa  fa-remove"></i></a>
					   </td>
                      </tr>
					  <?php }?>
                     </tbody>
		...
		<?php }?><!-----LIST CLOSE----------------->
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Enter Details For Religion </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../model/religion.php">
				...
				// print_r($res);
				  ...
				  <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title">Update Details For Religion </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../model/religion.php">
