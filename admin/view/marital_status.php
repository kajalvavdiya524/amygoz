		  ...
		  <div class="content">
				 <!-- Main content -->
					  <div class="row">
						<div class="col-xs-12">
						  <div class="box">
							<a class="btn btn-info pull-right" href="index.php?p=marital_status&a=add"> Add New Record</a>
						</div>
						<?php 
						if($str!="")
						{?>
								 ...
								 <td> <?php echo $res[$i]['Id']; ?></td>
								  <td> <?php echo $res[$i]['Value']; ?></td>
								   ...
								   <?php if($res[$i]['Status']=='Y')
											{?>
												<a class="btn btn-success" href="../model/marital_status.php?a=update&status=N&id=<?php echo $res[$i]['Id']; ?>" title="Click to IN-Active Mode"><i class="fa fa-check"></i></a>
											<?php }?>
											<?php
											if($res[$i]['Status']=='N')	
											{?>
												<a class="btn btn-danger"  href="../model/marital_status.php?a=update&status=Y&id=<?php echo $res[$i]['Id']; ?>" title="Click to Active Mode"><i class="fa fa-hand-pointer-o"></i></a>
											<?php }?>
									</td>
								   <td>
								   <a class="btn btn-success" href="index.php?p=marital_status&a=edit&id=<?php echo $res[$i]['Id']; ?>"><i class="fa fa-edit"></i></a>
						 <a class="btn btn-danger"href="../model/marital_status.php?a=delete&id=<?php echo $res[$i]['Id']; ?>"><i class="fa  fa-remove"></i></a>
								   </td>
						  </tr>
								  <?php }?>
								 </tbody>
					  ...
					  <div class="box box-info">
							<div class="box-header with-border">
							  <h3 class="box-title">Enter Details For Marital Status </h3>
								</div><!-- /.box-header -->
								<!-- form start -->
								<form class="form-horizontal" method="post" action="../model/marital_status.php">
					 ...
					 <?php if($a=='edit')
					  ...
					  <div class="box box-info">
							<div class="box-header with-border">
								<h3 class="box-title">Update Records For Marital Status </h3>
							</div><!-- /.box-header -->
								<!-- form start -->
								<form class="form-horizontal" method="post" action="../model/marital_status.php">
							...
							<div class="box-body">
									...
									<div class="form-group">
									  ...
									  <div class="col-sm-6">
									<label for="inputEmail3" >
									<input type="radio" name="status" value="Y" <?php echo $chk1;?>>  Y</label><label for=	"inputEmail3" >
