...
<!-- Content Wrapper. Contains page content -->
      ...
      <div class="content">
         <!-- Main content -->
          ...
          <div class="row">
		   <div class="box">
	<a class="btn btn-info pull-right" href="index.php?p=diet&a=add"> Add New Record</a>
	</div>
            <div class="col-xs-12">
					 ...
					 <td> <?php echo $res[$i]['Id']; ?></td>
					  <td> <?php echo $res[$i]['Value']; ?></td>
					   ...
					   <?php if($res[$i]['Status']=='Y')
								{?>
									<a class="btn btn-success" href="../model/diet.php?a=update&status=N&id=<?php echo $res[$i]['Id']; ?> "title="Click to IN-Active Mode"><i class="fa fa-check"></i></a>
								<?php }?>
								<?php
								if($res[$i]['Status']=='N')	
								{?>
									<a class="btn btn-danger" href="../model/diet.php?a=update&status=Y&id=<?php echo $res[$i]['Id']; ?>" title="Click to Active Mode"><i class="fa fa-hand-pointer-o"></i></a>
								<?php }?>
						</td>
					   <td>
					   <a class="btn btn-success" href="index.php?p=diet&a=edit&id=<?php echo $res[$i]['Id']; ?>"><i class="fa fa-edit"></i></a>
					   <a class="btn btn-danger" href="../model/diet.php?a=delete&id=<?php echo $res[$i]['Id']; ?>" ><i class="fa  fa-remove"></i></a>
					   </td>
                      </tr>
					  <?php }?>
                     </tbody>
