...
if($a=='update')
{
		...
		if($res)
		{
		header('location:../view/index.php?p=users&msg=1&start='.$start.'&action='.$action.'&val='.$val.'&option='.$option);
		}
		else
		{
		header('location:../view/index.php?p=users&msg=0&start='.$start.'&action='.$action.'&val='.$val.'&option='.$option);
		}
}
...
if($a=='block')
{
		...
		if($res)
		{
		header('location:../view/index.php?p=users&msg=1&start='.$start);
		}
		else
		{
